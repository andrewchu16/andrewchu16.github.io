...
function Navigation() {
    return (
            ...
            <a className="lg:text-4xl text-2xl hover:text-stone-300 hover:bg-stone-700 p-2 rounded-2xl transition-colors duration-200 ease-in-out flex items-center" href={window.location.href}>
                <img className="h-12" src={bookImage} /><h1 className="mx-2">Book-Smart Reviews</h1>
            </a>
...
function Header() {
    ...
    <header>
        ...
        <img className="block mx-auto mb-4" src={movieImage} draggable="false" />
